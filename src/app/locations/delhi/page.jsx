// src/app/locations/delhi/page.jsx
"use client";
...
export default function DelhiLocationPage() {
  ...
  // Advanced Local SEO Schema specifically for Delhi Location
  const delhiLocalSchema = {
    "@context": "https://schema.org",
    "@type": "ComputerStore",
    "name": "LPCARE.TECH Delhi Hardware Repair Lab Services",
    "image": "https://lpcare.tech/logo/lpcaretech.png",
    "@id": "https://lpcare.tech/locations/delhi",
    "url": "https://lpcare.tech/locations/delhi",
    "telephone": "+918557065447",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Noida sec-168 chhapraoli, Near SK Homes (Serving Delhi NCR)",
    ...
    "priceRange": "INR",
    "description": "Independent physical laptop hardware repair lab serving Delhi NCR, specializing in screen replacement, dead motherboard recovery, and chip-level micro-soldering."
  };
  ...
  return (
    <div className="min-h-screen bg-background text-text-main relative overflow-hidden selection:bg-secondary/10 selection:text-secondary">
      ...
      {/* Injecting Delhi Specific Local SEO Schema */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(delhiLocalSchema) }}
      />
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto z-10 text-center" aria-label="Delhi Repair Services">
        <motion.div
        ...
        >
          <div className="inline-flex items-center gap-2 border border-secondary/20 bg-secondary/5 text-secondary px-4 py-2 rounded-full text-xs font-bold tracking-[0.2em] uppercase mb-6 shadow-sm">
            ...
            Serving South Delhi and East Delhi
          </div>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-text-main mb-6 leading-tight">
            Premium Hardware <br /> Repair in <span className="text-secondary">Delhi NCR.</span>
          </h1>
          <p className="text-text-main/70 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed mb-10">
            We are Delhi NCR's trusted independent micro-soldering laboratory. We revive dead motherboards and replace physically damaged laptop screens using high-quality OEM components for clients across New Delhi.
          </p>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto relative z-10" aria-label="Delhi Hardware Services">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-text-main mb-4">
            Our Delhi <span className="text-secondary">Hardware Expertise</span>
          </h2>
          <p className="text-text-main/70 max-w-2xl mx-auto">Providing secure hardware diagnostics and physical repairs for individual consumers and corporate fleets across South Delhi, East Delhi, and surrounding areas.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <article className="bg-primary border border-secondary/10 p-8 rounded-2xl hover:shadow-md hover:border-secondary/30 transition-all duration-300">
            ...
            <p className="text-sm text-text-main/70 leading-relaxed">Shattered screens, bleeding LCDs, or broken display hinges. We execute precision physical replacements using high-grade panels for clients in Delhi.</p>
          </article>
          ...
          <article className="bg-primary border border-secondary/10 p-8 rounded-2xl hover:shadow-md hover:border-secondary/30 transition-all duration-300">
            ...
            <p className="text-sm text-text-main/70 leading-relaxed">Our lab specializes in chip-level logic board recovery. We physically replace shorted capacitors, saving Delhi residents the massive cost of a completely new board.</p>
          </article>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-6 bg-background border border-secondary/20 rounded-xl shadow-sm">
            ...
            <p className="text-xs text-text-main/60 leading-relaxed font-medium">
              We are a strictly independent physical hardware diagnostic and micro-soldering laboratory serving Delhi NCR. We are NOT officially affiliated with, authorized by, sponsored by, or endorsed by Apple, Dell, HP, Lenovo, or any other original equipment manufacturer. 
              <br /><br />
