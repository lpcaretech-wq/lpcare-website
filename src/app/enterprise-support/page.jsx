...
export default function EnterpriseSupport() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-main selection:bg-secondary/10 selection:text-secondary relative pb-12">
      ...
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-75 md:w-150 h-75 bg-accent/5 rounded-full blur-[100px] pointer-events-none z-0"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-10 justify-center lg:justify-start">
              <a href="tel:+918557065447" className="bg-secondary text-primary hover:bg-black font-bold py-3.5 px-8 rounded-full tracking-widest uppercase text-xs transition-all duration-300 shadow-premium flex items-center justify-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                Call Lab Expert
              </a>
              <a href="https://wa.me/918557065447?text=Hi%20LPCARE%20Lab!%20I%20would%20like%20to%20book%20a%20hardware%20diagnostic." target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white hover:bg-green-600 font-bold py-3.5 px-8 rounded-full tracking-widest uppercase text-xs transition-all duration-300 shadow-premium flex items-center justify-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="relative flex items-center">
                  ...
                  <input type="tel" name="phone" required minLength="10" maxLength="10" pattern="[0-9]{10}" onInput={handlePhoneInput} className="w-full bg-background border border-secondary/10 rounded-xl pl-12 pr-4 py-3 text-sm text-text-main focus:border-accent outline-none" placeholder="Phone Number *" />
                </div>
              </div>
              ...
              <button type="submit" disabled={isSubmitting} className={`w-full py-4 rounded-xl font-black text-xs md:text-sm tracking-widest uppercase transition-all duration-300 shadow-premium flex items-center justify-center gap-2 ${isSubmitting ? "bg-secondary/50 text-primary cursor-not-allowed" : "bg-secondary text-primary hover:bg-black"}`}>
