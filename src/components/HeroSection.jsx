...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center bg-background text-text-main overflow-hidden px-6 pb-16 pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-8 w-full">
        ...
        <div className="flex-1 text-center lg:text-left z-20">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-3 bg-primary border border-accent/20 shadow-premium px-5 py-2.5 rounded-full text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase mb-8"
          >
            <span className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-secondary opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-secondary"></span>
            </span>
            <span className="text-secondary">Delhi NCR's Premium Hardware Lab</span>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm font-bold text-secondary tracking-wide uppercase">
              <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
              Data Secure
            </div>
            <div className="flex items-center gap-2 text-sm font-bold text-secondary tracking-wide uppercase">
              <svg className="w-5 h-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              Fast Turnaround
            </div>
          </motion.div>
          ...
          >
            {/* Yahan aapka updated number add ho gaya hai */}
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-1.5 bg-[#1A1A1A] rounded-t-xl rounded-b-sm p-1.5 flex flex-col" style={{ transformStyle: "preserve-3d" }}>
                 <div className="w-full h-full bg-[#000000] border border-[#333333] rounded-md relative overflow-hidden flex flex-col justify-center items-center shadow-inner">
                    ...
                    {/* Premium Apple-like minimal Boot Screen */}
                    <div className="w-8 h-8 border border-white/60 rounded-full flex items-center justify-center mb-3 relative">
                      ...
                      <svg className="absolute w-12 h-12 text-white/10 animate-spin-slow" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="10" strokeWidth="1" strokeDasharray="4 4" /></svg>
                    </div>
            ...
            >
              <div className="bg-primary/90 backdrop-blur-md border border-accent/20 px-4 py-2 rounded-full shadow-premium flex items-center gap-2">
                <svg className="w-3.5 h-3.5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
